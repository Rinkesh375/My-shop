...
function Slider() {
  ...
  return (
    ...
    <div className="downloadAppContainer">
      <img className="downloadAppImage" src="https://media6.ppl-media.com/tr:w-1280,c-at_max,pr-true,dpr-2/mediafiles/ecomm/misc/1678881030_1280x272-web-1.jpg" alt="Download App" />
    </div>
    </>
